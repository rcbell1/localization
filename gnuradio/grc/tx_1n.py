...
class tx_1n(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx 1N")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx 1N")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_1n")
        ...
        self.sps = sps = 2
        self.span = span = 10
        self.samp_rate = samp_rate = 200e6/50
        ...
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 31, 1, 10, 200)
        self._tx_gain_win = RangeWidget(self._tx_gain_range, self.set_tx_gain, 'Gain', "counter_slider", float)
